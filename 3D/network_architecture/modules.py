...
#                  norm_layer='bn_3d', act_layer='silu'):
#         super().__init__()
...
#                 nn.Conv3d(dim_in, emb_dim, kernel_size, stride, padding, dilations[i], groups=c_group),
...
#             x = reduce(x, 'b c h w d n -> b c h w d', 'mean').contiguous()
#         return x