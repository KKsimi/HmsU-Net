...
def test():
    label_path= '/Hmsunet/DATASET/nnUNet_raw/nnUNet_raw_data/Task021_Synapse/' # Replace None by full path of "DATASET/unetr_pp_raw/unetr_pp_raw_data/Task002_Synapse/"
    ...
    infer_list = sorted(glob.glob(os.path.join(infer_path, 'output21', '*nii.gz')))
