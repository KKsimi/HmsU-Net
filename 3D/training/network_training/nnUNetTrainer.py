...
from hmsunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from hmsunet.training.loss_functions.dice_loss import DC_and_CE_loss
from hmsunet.training.network_training.network_trainer import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = HmsUnet(num_classes=self.num_classes, in_chans=self.in_chans, spatial=3)
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(hmsunet.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="hmsunet.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in hmsunet.preprocessing" % \
                                               preprocessor_name
