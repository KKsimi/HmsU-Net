...
import argparse
from hmsunet.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(hmsunet.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "hmsunet.training.network_training")

    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in hmsunet.training.network_training")
    else:
